...
from src.agents import Wolf, Sheep, GrassPatch
from src.model import WolfSheep
...
def wolf_sheep_portrayal(agent):
    ...
    if type(agent) is Sheep:
        portrayal["Shape"] = "src/resources/sheep.png"
        # https://icons8.com/web-app/433/sheep
        portrayal["scale"] = 0.9
        portrayal["Layer"] = 1

    elif type(agent) is Wolf:
        portrayal["Shape"] = "src/resources/wolf.png"
